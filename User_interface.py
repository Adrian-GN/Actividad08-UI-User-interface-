...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBox.setMinimumSize(QSize(42, 22))
        self.spinBox.setMaximumSize(QSize(42, 22))
        ...
        self.spinBox_3.setMaximumSize(QSize(42, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Color (rgb):", None))
